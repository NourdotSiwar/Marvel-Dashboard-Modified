...
const charts = () => {
      ...
      // this is the array of colors that will be used for the pie chart
      ...
      useEffect(() => {
            // this is the function that will make the api call
...
// this is the function that will render the pie chart
...
const renderCustomizedLabel = ({
      ...
      return (
            <div>
                  ...
                  {data ? (
                        <div className='chartDiv'>
                              <BarChart width={1000} height={500} data={data.data.results} margin={{
                  ...
                  {data ? (
                        <div className='chartDiv'>
                              ...
                              <Scatter data={data.data.results} fill="white" line shape="star" />
                  ...
                  {data ? (
                        <div className='chartDiv'>
                              ...
                              <Pie data={data.data.results} cx={550} cy={230} labelLine={false}
                              label={renderCustomizedLabel} outerRadius={200} fill="#8884d8" dataKey="stories.available"  >
